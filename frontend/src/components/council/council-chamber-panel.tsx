        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
            {[
              ...
              const isActive = session.councillors[c.id as RETRIEVING_COUNCILLOR_IDS]?.status === "complete" || session.councillors[c.id as RETRIEVING_COUNCILLOR_IDS]?.status === "running";
              const isComplete = session.councillors[c.id as RETRIEVING_COUNCILLOR_IDS]?.status === "complete";
              return (
